...
type CreateRequestHookResult<Result = never> = [
	boolean,
	(
		dispatch?: Dispatch<Result>,
		errDispatch?: Dispatch<Error | null>
	) => Promise<Result>,
	Error | null
]
...
const useHttpRequest = <Body, Result>({
	...
	headers,
	token,
}: CreateHttpRequestParams<Body>): CreateRequestHookResult<Result> => {
